...
//sp_columns
            ...
            try
            {
                ...
                conn = new SqlConnection("Data Source=DFHLSCASQL01;Initial Catalog=master;Integrated Security=True");
                conn.Open();
                ...
                while (rdr.Read())
                {
                    ...
                    SqlConnection conn2 = new SqlConnection("Data Source=DFHLSCASQL01;Initial Catalog=" + rdr["DATABASE_NAME"].ToString() + ";Integrated Security=True");
                    conn2.Open();
        ...
        {
            string[] filePaths = Directory.GetFiles(@"C:\Documents and Settings\willig02\Desktop\Desktop\Reports\", "*.url", SearchOption.TopDirectoryOnly);
