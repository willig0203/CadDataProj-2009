...
Imports rnsCadDataProj.nsuserctls.ucE044DRN
Imports rnsCadDataProj.nsMods
Namespace nsForms

    Public Class E024ItmMstrDetailFrm
...
#End Region
        ...
        Public Sub FindRec(ByVal dg As DataGrid, ByVal Col As Integer)
            If daComp.dbconnE025BomItmMstr.ConnectionString.ToString = "" Then
                Dim file As New System.IO.StreamReader("C:\DataLinks" & "\DBTest.txt")
                Dim words As String = file.ReadToEnd() : file.Close()
                daComp.dbconnE025BomItmMstr.ConnectionString = words
            ...
            With dvItmMstrs
                .Table = daComp.DataSet11.Tables("E024ItemMasterInput")
                Dim str As String
