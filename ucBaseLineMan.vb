...
Imports rnsCadDataProj.nsForms.CadDataProjForm
Imports rnsCadDataProj.nsMods

Namespace nsUserCtls

    Public Class ucBaseLineMan
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.DataGrid2.Location = New System.Drawing.Point(0, 171)
            Me.DataGrid2.Name = "DataGrid2"
            Me.DataGrid2.Size = New System.Drawing.Size(424, 171)
            ...
            Me.DataGrid1.Size = New System.Drawing.Size(424, 168)
...
#End Region
        ...
        Private Sub ucBaseLineMan_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            daComp.dbconnBslnMan.ConnectionString = words

            daComp.daE002CBD.Fill(daComp.DataSet11.E002ConfigurationBaselineDocument)
            DataGrid1.DataSource = daComp.DataSet11.E002ConfigurationBaselineDocument
            daComp.daE002CBDSubTbl.Fill(daComp.DataSet11.E002CBDSubTable)

            DataGrid2.DataSource = daComp.DataSet11.E002CBDSubTable

            daComp.daE003AsBlt.Fill(daComp.DataSet11.E003AsBuiltConfigurationRecord)
            DataGrid3.DataSource = daComp.DataSet11.E003AsBuiltConfigurationRecord
            daComp.daE003AsBltSubTbl.Fill(daComp.DataSet11.E003AsBltSubTbl)

            DataGrid4.DataSource = daComp.DataSet11.E003AsBltSubTbl
